...
MIN_PIXELS_CENTRE     = 10000 # enter CENTRE_ON_CUBE from WALL_FOLLOW
...
class SearchAndNavigate(Node):
    ...
    def log_cube_world_position(self):
        """Log the red cube's world (x, y) position.

        Cube is centred in image so nearest_front is the range straight to it.
        """
